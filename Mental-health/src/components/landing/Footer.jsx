...
function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#7c3aed] via-[#6d28d9] to-[#5b21b6] dark:from-mindmate-600 dark:via-mindmate-700 dark:to-mindmate-800 text-white py-8 sm:py-12 shadow-2xl border-t border-purple-600/30">
