...
const Navbar = ({ onLogout }) => {
  ...
  return (
    <nav className="w-full z-50 px-4 sm:px-6 py-3 sm:py-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-mindmate-200 dark:border-slate-800 shadow-soft sticky top-0 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Brand Name */}
        <div className="flex items-center">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-mindmate-600 dark:text-white tracking-tight whitespace-nowrap">
            The MindMates
          </h1>
        </div>
        ...
        <div className="hidden md:flex items-center gap-3 lg:gap-4">
          ...
          <div className="relative" ref={notificationsRef}>
            <button
              ...
              className="p-2.5 rounded-xl bg-mindmate-100 dark:bg-slate-800 hover:bg-mindmate-200 dark:hover:bg-slate-700 text-mindmate-700 dark:text-slate-300 transition-all duration-200 shadow-sm hover:shadow-md"
            >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-mindmate-500 to-mindmate-600 hover:from-mindmate-600 hover:to-mindmate-700 text-white font-semibold shadow-purple hover:shadow-purple-lg transition-all duration-200"
        ...
        <button
          ...
          className="md:hidden p-2.5 rounded-xl bg-mindmate-100 dark:bg-slate-800 hover:bg-mindmate-200 dark:hover:bg-slate-700 text-mindmate-700 dark:text-slate-300 transition-all duration-200 shadow-sm active:scale-95"
        >
      ...
      <AnimatePresence>
        {navOpen && (
          ...
          >
            ...
            <button
              onClick={handleGoToSettings}
              className="w-full flex items-center justify-between px-5 py-3.5 rounded-2xl bg-mindmate-50 dark:bg-slate-800 text-mindmate-700 dark:text-slate-300 hover:bg-mindmate-100 dark:hover:bg-slate-700 transition-all duration-200 shadow-sm active:scale-98"
            >
            ...
            <button
              onClick={() => navigate('/user/topup')}
              className="w-full flex items-center justify-between px-5 py-3.5 rounded-2xl bg-gradient-to-r from-mindmate-500 to-mindmate-600 hover:from-mindmate-600 hover:to-mindmate-700 text-white transition-all duration-200 shadow-purple active:scale-98"
            >
